...
public class PaginationStatementHandlerInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if("1".equals(SystemPropertiesUtil.get("is_debug"))){
            sql = sql.replaceAll("\\/\\*slave\\*\\/", "");
            sql = sql.replaceAll("\\/\\*master\\*\\/", "");
        }
       ...
       // logger.info("最终执行的SQL : " + boundSql.getSql());
        return invocation.proceed();
    }
