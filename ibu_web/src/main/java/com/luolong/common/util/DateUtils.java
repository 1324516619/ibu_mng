...
public class DateUtils {
  ...
  /**
   ...
   public static void main(String[] args) throws ParseException {
	   //System.out.println(getMonthBetween("2016-04-04", "2016-09-04"));
	   //System.out.println(getDateBetweenDays(-1,"2017-09-01"));
...
//       System.out.println(getToday(" HH:mm:ss"));
       ...
       System.out.println(dateCompareNew("2018-01-01", "2017-12-31", "yyyy-MM-dd"));
  }
}
